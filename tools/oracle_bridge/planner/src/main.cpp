...
void usage() {
    std::fputs(
        ...
        "                            Act-4 boss room stops parking (S3.33).\n"
        ...
        "                            and Act 4 is reachable, but its BOSS ROOM\n"
        "                            still parks on entry (S3.33), so it matches\n"
        "                            NOTHING -- an honest zero, not a scan bug.\n"
