...
void usage() {
    std::fputs(
        ...
        "                            sim_search_blind (the information-\n"
        "                            limited twin: every rollout runs on a\n"
        "                            resample_hidden twin instead of the\n"
        "                            true controller -- SIM_SEARCH minus\n"
        "                            SIM_SEARCH_BLIND on paired seeds is the\n"
        "                            information premium, see\n"
        "                            docs/verification/sim-search-blind.md),\n"
        "                            sim_search_keys_deep (S3.61: sim_search_keys\n"
        "                            plus a bounded 3rd searched ply and a\n"
        "                            widened turn window, boss floors only --\n"
        "                            the escalation lever after re-seeding\n"
        "                            alone moved double_boss 0 -> 14 with no\n"
        "                            keyed A20 victory, see\n"
        "                            docs/verification/s3-61-reach.md)\n"
        "                            (default: random)\n"
        ...
        "                            S3.21 on; it stopped matching nothing at\n"
        "                            S3.33/S3.41/S3.42/S3.43 (Act-4 rooms went\n"
        "                            ordinary and the Shield-and-Spear/Heart\n"
        "                            registry rows landed) -- a zero here now\n"
        "                            reports a real reach limit, not a park.\n"
        ...
        "                            became reachable at S3.32 (the Door).\n"
        ...
        "                            three-way shorthand.\n"
        "  --need-heart-kill         the Corrupt Heart was killed. This is the\n"
        "                            act-4 boss-kill bit under the name its\n"
        "                            consumer uses. S3.32 moved kFinalAct to 4\n"
        "                            and S3.33/S3.41-43 landed the Act-4 rooms\n"
        "                            and boss content, so this clause can now\n"
        "                            answer nonnegative -- a zero reports a\n"
        "                            real reach limit (S3.61), not a park.\n"
