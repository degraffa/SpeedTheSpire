...
// It pins no BODY behaviour: ids 32-44 are identity rows with `implemented`
// absent, and their option trees / A15 branches belong to S2.31-S2.32; ids
// 45-51 flipped implemented with S2.33 (bodies in beyond_events.cpp, behaviour
// pinned in beyond_events_test.cpp -- this file keeps only the registry
// metadata expectations for them). The
