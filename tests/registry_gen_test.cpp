...
TEST(RegistryGen, ManifestCounts) {
    ...
    EXPECT_EQ(m::kPowersCount, 70u);  // + S2.24's STASIS (98), the Bronze
                                      // Orb's stolen-card holder -- that
                                      // batch's whole PowerId grant, spent
                                      // exactly, so 98 leaves no gap.
                                      ...
                                      // not this one's
    EXPECT_EQ(m::kMonstersCount, 55u); // + S2.24's five Act-2 City-boss rows:
                                       // Bronze Automaton (40), Bronze Orb
                                       // (41), Champ (42), The Collector (43),
                                       // Torch Head (44) -- the 40-44 block
                                       // spent exactly; 45-48 stay UNISSUED,
                                       ...
                                       // + S2.28's four Act-3 bosses: Awakened
                                       // One (62), Time Eater (63), Donu (64),
                                       // Deca (65) -- the 62-65 block spent
                                       // exactly; 58-61 are S2.27's, not gaps.
    ...
    EXPECT_EQ(m::kTotalCount, 572u);  // 132 + 70 + 55 + 150 + 33 + 51 + 61 + 20
}
