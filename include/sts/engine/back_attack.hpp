...
//     group (SmokeBomb.java:51-63), irrespective of liveness or amount.
//     Guard death cleanup also reads the marker. Queue timing can therefore
//     affect the potion mask and other queued interactions within a resolution,
