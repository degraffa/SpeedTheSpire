// B3.4 (Flex) power -- native hook body (moved verbatim out of power_hooks.cpp's
// escape-hatch switch; see power_native.hpp for the split's rationale).

#include "powers_b3_4.hpp"
