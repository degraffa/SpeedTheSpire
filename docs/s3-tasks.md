...
- **The evidence rule (owner directive, 2026-09-03; supersedes the unit-test
  ...
  and they remain. **conventions.md itself still carries the superseded
  wording** — a real document conflict under conventions §4, recorded in the
  Deferred obligations table with an owner, because this planning exercise was
  scoped out of editing that file.
