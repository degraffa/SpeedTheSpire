...
- **T3.3** `[~]` ∥ **Run-level planner.** Sparse expectimax over the
  ...
  **Inherited (T3.3a–c):** complete the fitted public reveal/value model,
  ...
  policy and does not provide counterfactual route values.
