...
That is corrected: the direct back-attack multiplier reads the geometric
predicate, while Smoke Bomb legality and guard death cleanup read marker
presence. The existing declared timing deviation can therefore affect the
potion mask during a card resolution; effects on other queued interactions
remain a live-witness question.
